...
published: true
video_url:
chapters: [{"label":"The arguing loop","at":0},{"label":"It is the process, not the prompt","at":0},{"label":"Transform, do not create","at":0},{"label":"Never let one AI grade its own homework","at":0}]
