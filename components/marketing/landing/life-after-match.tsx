...
/**
 * "Life after LearnHub matches you with your career" — the dark panel that
...
export function LifeAfterMatch() {
  return (
    <section className="bg-white px-[clamp(1rem,4vw,2.5rem)] py-[clamp(2rem,5vw,5rem)] text-ink">
      <div className="mx-auto max-w-[1200px]">
        ...
        <Reveal rootMargin="0px 0px -6% 0px">
          {/* The graph-paper backdrop is two 1px gradients on a 64px grid. No
              utility covers this, so it is inline — a Tailwind arbitrary value
              would need every comma and space escaped and would read far worse. */}
          <div
            className="overflow-hidden rounded-[28px] bg-ink px-[clamp(1.25rem,3.2vw,3.5rem)] py-[clamp(1.75rem,4vw,4rem)] text-white"
            style={{
              backgroundImage:
            ...
            <div className="grid items-start gap-[clamp(1.75rem,3.2vw,3.5rem)] [grid-template-columns:repeat(auto-fit,minmax(320px,1fr))]">
              ...
              <div className="flex max-w-[34ch] flex-col gap-[clamp(1.125rem,2vw,1.75rem)]">
                ...
                <p className="text-pretty m-0 text-[clamp(0.9375rem,1.4vw,1.125rem)] leading-[1.65] text-white/[0.66]">
                  The match is the start, not the finish. What follows is a plan built for your
                  hours, practice that leaves proof, and a way into the companies hiring near you.
                </p>
              ...
              <div className="flex flex-col gap-3.5">
                ...
                <span className="pl-1 text-xs leading-[1.5] text-white/[0.45]">
                  Sample path shown. Your AI advisor writes the real one from your answers.
                </span>
              </div>
            </div>
          </div>
