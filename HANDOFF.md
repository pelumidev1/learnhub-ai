...
commits, `d428d59`..`763ccf9`. A public one-screen form (name, email, WhatsApp
with country code, one of three cohorts) posting through a Server Action on the
service role into a new `waitlist` table; `/waitlist` redirects to it. Files:
